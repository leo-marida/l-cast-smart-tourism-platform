...
('Anjar Ruins', 'Bekaa', 'Umayyad period ruins.', 0.75, 
 ST_SetSRID(ST_MakePoint(35.9297, 33.7258), 4326)), -- FIXED: Minor adjustment to ruins center
...
('Pigeon Rocks', 'Beirut', 'Iconic natural arch.', 0.93, 
 ST_SetSRID(ST_MakePoint(35.4735, 33.8902), 4326)),
...
('Taanayel Lake', 'Bekaa', 'Peaceful nature reserve and lake ideal for walking.', 0.86, 
 ST_SetSRID(ST_MakePoint(35.8683, 33.7946), 4326)), -- FIXED: Moved 600m to actual park entrance
...
('Beaufort Castle', 'Nabatieh', 'Crusader fortress offering panoramic views of the south.', 0.81, 
 ST_SetSRID(ST_MakePoint(35.5320, 33.3244), 4326)), -- FIXED: Was off by ~500m

('Qadisha Valley', 'Bcharre', 'The Holy Valley, deep gorge with ancient monasteries.', 0.91, 
 ST_SetSRID(ST_MakePoint(35.9500, 34.2500), 4326)), -- FIXED: Moved 3km West to valley center

('Mzaar Kfardebian', 'Kfardebian', 'Largest ski resort in the Middle East.', 0.94, 
 ST_SetSRID(ST_MakePoint(35.8216, 34.0066), 4326)), -- FIXED: Moved 2km North to ski slopes

('Tripoli Citadel', 'Tripoli', 'Raymond de Saint-Gilles Citadel overlooking the city.', 0.85, 
 ST_SetSRID(ST_MakePoint(35.8445, 34.4334), 4326)),
...
('Mseilha Fort', 'Batroun', 'Historic fortification built on a rocky limestone rock.', 0.86, 
 ST_SetSRID(ST_MakePoint(35.6897, 34.2736), 4326)), -- FIXED: Was off by 1.5km (in the sea/highway)

('Horsh Ehden Nature Reserve', 'Ehden', 'A nature reserve on the slopes of Mount Lebanon with unique biodiversity.', 0.91, 
 ST_SetSRID(ST_MakePoint(35.9765, 34.3049), 4326)), -- FIXED: Moved 1.5km to main reserve entrance
...
('Douma Village', 'Batroun', 'Traditional village known for its red-tiled roof houses.', 0.85, 
 ST_SetSRID(ST_MakePoint(35.8333, 34.2000), 4326));