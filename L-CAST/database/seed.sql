...
-- 3. Insert Data with NAVIGATION-READY COORDINATES (Entrances/Viewpoints)
-- Note: ST_MakePoint order is (Longitude, Latitude)

INSERT INTO pois (name, region, description, base_popularity_score, image_url, location) VALUES 
('Raouche Rocks', 'Beirut', 'Famous rock formation off the coast of Raouche.', 0.95, 'https://commons.wikimedia.org/wiki/Special:FilePath/Pigeon_Rocks_of_Beirut,_Rock_of_Raouche,_Beirut,_Lebanon.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.4735, 33.8902), 4326)), -- The Corniche Viewpoint

('Byblos Citadel', 'Jbeil', 'Ancient crusader castle and Phoenician ruins.', 0.90, 'https://commons.wikimedia.org/wiki/Special:FilePath/Byblos_Castle,_Byblos,_Lebanon.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.6482, 34.1206), 4326)), -- Castle Entrance
...
('Baalbek Temples', 'Bekaa', 'Massive Roman temple complex.', 0.85, 'https://commons.wikimedia.org/wiki/Special:FilePath/Temple_of_Bacchus.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(36.2086, 34.0059), 4326)), -- Main Visitor Entrance

('Mleeta Landmark', 'South', 'Resistance tourism landmark.', 0.70, 'https://commons.wikimedia.org/wiki/Special:FilePath/Mleeta,_South_Lebanon.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.5401, 33.5204), 4326)), -- Main Gate
...
('Sidon Sea Castle', 'Sidon', 'Crusader fortress built on a small island.', 0.80, 'https://commons.wikimedia.org/wiki/Special:FilePath/Sidon_Sea_Castle.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.3695, 33.5672), 4326)), -- The Causeway Entrance
...
('Beiteddine Palace', 'Chouf', '19th-century palace complex.', 0.88, 'https://commons.wikimedia.org/wiki/Special:FilePath/Lebanon_banner_Beiteddine_Palace.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.5807, 33.6953), 4326)), -- Palace Entrance

('Anjar Ruins', 'Bekaa', 'Umayyad period ruins.', 0.75, 'https://commons.wikimedia.org/wiki/Special:FilePath/Anjar.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.9270, 33.7262), 4326)), -- Site Entrance
...
('National Museum of Beirut', 'Beirut', 'Principal museum of archaeology.', 0.92, 'https://commons.wikimedia.org/wiki/Special:FilePath/National_Museum_of_Beirut.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.5149, 33.8785), 4326)), -- Main Gate
...
('Jezzine Waterfall', 'South', 'Highest waterfall in Lebanon.', 0.82, 'https://commons.wikimedia.org/wiki/Special:FilePath/Lebanon_-_Jezine_Waterfalls.waterfall.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.5822, 33.5433), 4326)), -- The Cliff Edge
...
('Ksara Winery', 'Zahle', 'Oldest winery in Lebanon.', 0.85, 'https://commons.wikimedia.org/wiki/Special:FilePath/Chateau-Ksara-Observatoire-Winery-Lebanon-Wine.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.8900, 33.8233), 4326)), -- Winery Entrance
...
('Our Lady of Lebanon', 'Jounieh', 'Marian shrine in Harissa.', 0.94, 'https://commons.wikimedia.org/wiki/Special:FilePath/Harissa_-_Lady_of_Lebanon_(4011272632).jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.6517, 33.9818), 4326)), -- Base of Statue

('Pigeon Rocks', 'Beirut', 'Iconic natural arch.', 0.93, 'https://commons.wikimedia.org/wiki/Special:FilePath/Pigeon_Rocks_of_Beirut,_Rock_of_Raouche,_Beirut,_Lebanon.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.4735, 33.8902), 4326)), -- Viewing Point
...
('Mar Mikhael', 'Beirut', 'Nightlife and art hub.', 0.88, 'https://commons.wikimedia.org/wiki/Special:FilePath/Mar_Mikhael_Stairs.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.5266, 33.8994), 4326)), -- Main Street
...
('Tannourine Cedar Reserve', 'Batroun', 'Large cedar forest.', 0.89, 'https://commons.wikimedia.org/wiki/Special:FilePath/Cedars_in_Tannourine.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.9262, 34.2084), 4326)), -- Forest Entrance

('Zaitunay Bay', 'Beirut', 'Luxury marina.', 0.91, 'https://commons.wikimedia.org/wiki/Special:FilePath/Zaitunay_Bay,_Downtown_Beirut,_Lebanon.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.4984, 33.9023), 4326)), -- The Boardwalk
...
('Chouf Cedar Reserve', 'Chouf', 'Largest nature reserve.', 0.90, 'https://commons.wikimedia.org/wiki/Special:FilePath/Barouk_Cedars.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.6963, 33.6933), 4326)); -- Barouk Entrance

-- Extra Locations (North/South/Bekaa)
INSERT INTO pois (name, region, description, base_popularity_score, image_url, location) VALUES 
('Jeita Grotto', 'Jeita', 'Breathtaking system of crystallized limestone caves.', 0.98, 'https://commons.wikimedia.org/wiki/Special:FilePath/Upper_Jeita_Grotto.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.6418, 33.9450), 4326)), -- Visitor Parking
...
('Tyre Hippodrome', 'Tyre', 'One of the largest and best-preserved Roman hippodromes.', 0.90, 'https://commons.wikimedia.org/wiki/Special:FilePath/Roman_Hippodrome,_Tyre,_Lebanon.jpg?width=800', 
...
('Sursock Museum', 'Beirut', 'Modern art and contemporary culture museum.', 0.87, 'https://commons.wikimedia.org/wiki/Special:FilePath/Sursock_Museum,_Beirut,_2017.jpg?width=800', 
...
('Qadisha Valley', 'Bcharre', 'The Holy Valley, deep gorge with ancient monasteries.', 0.91, 'https://commons.wikimedia.org/wiki/Special:FilePath/View_of_the_Kadisha_Valley,_Lebanon.jpg?width=800', 
...
('Tripoli Citadel', 'Tripoli', 'Raymond de Saint-Gilles Citadel overlooking the city.', 0.85, 'https://commons.wikimedia.org/wiki/Special:FilePath/The_Citadel_of_Raymond_de_Saint-Gilles,_skyline_of_Tripoli,_Lebanon.jpg?width=800', 
 ST_SetSRID(ST_MakePoint(35.8436, 34.4333), 4326)),

('Baatara Gorge Waterfall', 'Tannourine', 'Stunning waterfall dropping 255m through three natural bridges.', 0.97, 'https://commons.wikimedia.org/wiki/Special:FilePath/Baatara_waterfall,_Lebanon_44162.jpg?width=800', 
...
('Mseilha Fort', 'Batroun', 'Historic fortification built on a rocky limestone rock.', 0.86, 'https://commons.wikimedia.org/wiki/Special:FilePath/Mseilha_fort,_Lebanon.jpg?width=800', 
...
('Douma Village', 'Batroun', 'Traditional village known for its red-tiled roof houses.', 0.85, 'https://commons.wikimedia.org/wiki/Special:FilePath/Douma,_centre_du_village.JPG?width=800', 
